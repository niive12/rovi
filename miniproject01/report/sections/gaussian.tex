...
The shifted midpoint was thus chosen to be 40\%.
...
The variance was found in the uniform area to be $56.5$.
...
\begin{itemize}
 \item Shifted median filter, kernel size 5x5, shifted midpoint to 40\%.
