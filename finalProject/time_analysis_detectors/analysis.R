...
plot(t,  sift_homograph, type="l", lty=1, ylim=c(0,0.75) , xlab="Image in set", ylab="Time [S]")
...
legend("topright", legend=rev(c("Keypoints","Descriptors","Homography")), col=rev(col), lty=array("solid",3),lwd=10);
q = dev.off()
