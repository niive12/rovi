...
rw::math::Q visualServoing(std::vector< double > &x, std::vector< double > &y, std::vector< double > &z, double f, rw::models::Device::Ptr &device, rw::kinematics::Frame * &endeffector, rw::kinematics::State &state, std::vector< cv::Vec2d > &mapping);
rw::math::Q visualServoing(std::vector< rw::math::Vector2D< double > > &uv, std::vector< double > &z, double f, rw::models::Device::Ptr &device, rw::kinematics::Frame * &endeffector, rw::kinematics::State &state, std::vector< cv::Vec2d > &mapping);
...
Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> du_fixed(std::vector< rw::math::Vector2D< double > > &uv, std::vector< cv::Vec2d > &mappings);
