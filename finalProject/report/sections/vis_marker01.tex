...
In figure \ref{fig:crossing_pints_marker} can it be seen that it works in images where there the lines is detected, but when the all the lines are not detected, 
